"""
Django settings for online_edu_python_project project.
...
try:
    from online_edu_python_project.secret_settings import *
except ImportError:
    pass

# Import all constants to use throughout our application
try:
    from online_edu_python_project.constants import *
except ImportError:
    pass
...
ROOT_URLCONF = 'online_edu_python_project.urls'
...
WSGI_APPLICATION = 'online_edu_python_project.wsgi.application'
